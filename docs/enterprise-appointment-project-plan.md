...
在 2026-07-20 規劃基線中，官網「線上諮詢」頁面的表單收集姓名、性別、年齡、手機、方便聯繫時間與諮詢問題，並連結至 LINE、Instagram、Facebook 等既有通路。這是當時的諮詢流程觀察，不是本專案現行欄位權威；現行合成欄位與正式待核准欄位分別以執行計畫、決策登錄與隱私文件為準。
