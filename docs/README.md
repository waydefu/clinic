...
- [Full-project master plan (2026-07-31)](product/full-project-master-plan-2026-07-31.md) — the single technical-strategy source for the rest of the project, including the corrected NIST SP 800-63B-4 and OWASP ASVS 5.0.0 baseline, post-approval G0～G5 control plane, Terraform/WIF/Cloud Run/Firestore/secret controls, Taiwan-law version locking, data migration order, stop conditions and expanded risk register
- [Full-project execution book (2026-07-31)](product/full-project-execution-book-2026-07-31.md) — the same plan turned into approval-baseline, per-slice request/plan/apply/verify/stabilize/handoff steps, detailed C1～C6 entry and exit evidence, Calendar and real-data release controls, Production Go/No-Go, operating handoff templates and authoritative-source mapping; Stage 0 is recorded as complete and Stage 1 remains current
