...
- [2026-08-07 UI visual baseline](reviews/ui-visual-baseline-2026-08-07.md) — **the current baseline**: ten reproducible desktop/mobile reference captures and their manifest, retaken after the treatment-card imagery fix; the diff-before-accept pass caught two workbench captures contaminated by a stray `:hover` (one of them already baked into the 2026-08-06 set), fixed by moving the cursor off-screen before the screenshot
