...
- [2026-08-20 UI visual baseline](reviews/ui-visual-baseline-2026-08-20.md) — **the current baseline**: ten GitHub-hosted warm-theme desktop/mobile references for the schedule-derived calendar, restored synthetic Case follow-up, booking Step 1–3 context and privacy return; reference evidence, not a cross-OS pixel gate
...
| 2026-08-20 | [Booking MVP owner acceptance](reviews/2026-08-20-booking-mvp-owner-acceptance.md) | Current Traditional Chinese handoff records the verified exact-C2 URL/expiry, warm theme, synthetic Case restoration, Payroll freeze, real-event calendar, booking/privacy context, booking-only vendor scope and the unchanged no-production/no-real-data boundary; earlier candidate C remains historical evidence |
