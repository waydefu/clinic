...
- [2026-08-20 UI visual baseline](reviews/ui-visual-baseline-2026-08-20.md) — **the current baseline**: nine reproducible desktop/mobile reference captures for the frozen-capability workbench (BOOK-MVP-003-B); the `#case-section` workload capture is gone because that capability has no UI entry, and every dated 2026-08-10 baseline file is preserved unchanged
- [2026-08-10 UI visual baseline](reviews/ui-visual-baseline-2026-08-10.md) — superseded on 2026-08-20, kept intact as dated evidence: ten reproducible desktop/mobile reference captures after the clinic homepage restructure; only the two `/clinic` images changed and the other eight remain byte-identical to 2026-08-07
...
| 2026-08-20 | [UI 視覺基準](reviews/ui-visual-baseline-2026-08-20.md) | 凍結能力隔離（BOOK-MVP-003-B）後的現行基線：九張 reference-only PNG 與 manifest；`#case-section` 工作區截圖隨其無 UI 入口而移出現行集合，2026-08-10 十張 dated evidence 原樣保留 |
