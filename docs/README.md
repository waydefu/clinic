...
| 2026-08-20 | [Booking MVP owner acceptance](reviews/2026-08-20-booking-mvp-owner-acceptance.md) | Traditional Chinese owner test handoff with the verified exact-C preview URL/expiry, frozen features, synthetic/privacy/Calendar boundaries, vendor delivery, CI evidence, rollback and remaining owner decisions. It is not production or real-data authority |
