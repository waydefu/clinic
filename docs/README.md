...
| Date | Review | Result |
| --- | --- | --- |
| 2026-08-20 | [Booking MVP owner acceptance](reviews/2026-08-20-booking-mvp-owner-acceptance.md) | Pre-deployment Traditional Chinese owner handoff: what to test, frozen features, synthetic/privacy/Calendar boundaries, vendor delivery, CI evidence, pending preview URL/expiry, rollback and remaining owner decisions. It is not production or real-data authority |
