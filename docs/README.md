...
| Date | Review | Result |
| --- | --- | --- |
| 2026-08-20 | [Booking MVP owner-refinement synthetic preview deployment](reviews/2026-08-20-booking-mvp-owner-refinement-synthetic-preview-deployment.md) | New C2 deployment record. It preserves the earlier candidate-C record as history and remains `PENDING EXACT-C2 DEPLOYMENT` until the exact pre-deployment-docs SHA is fully green, deployed only to the expiring `synthetic-review` channel and independently verified online |
...
| 2026-08-20 | [Booking MVP owner acceptance](reviews/2026-08-20-booking-mvp-owner-acceptance.md) | Current Traditional Chinese handoff marks the earlier exact-C preview as historical and C2 URL/expiry as pending until redeployment; it records warm theme, synthetic Case restoration, Payroll freeze, real-event calendar, booking/privacy context, booking-only vendor scope and the unchanged no-production/no-real-data boundary |
