...
下列 `記錄輸入` 來自 2026-07-27 問卷，只是供核准者確認或修正，並未改變
D-010 的 `pending` 狀態。

| 項目 | 核准答案 | 核准者／證據 |
| --- | --- | --- |
| 環境分離 | `dev / staging / production；各自獨立帳務與資料` | `[技術＋資安負責人]` |
| Firebase／Google Cloud 所有權 | `[記錄輸入：管理者＋開發者；須補法人所有權與最小角色，不得填入帳密]` | `[診所負責人]` |
| Firestore 資料位置與跨境評估 | `[記錄輸入：asia-east1；須補 D-002／跨境評估證據]` | `[隱私＋資安負責人]` |
| IAM 與管理者帳號 | `[最小角色、MFA、定期覆核]` | `[資安負責人]` |
| 服務帳號、Secret Manager 與輪替 | `[最小權限與輪替流程]` | `[技術＋資安負責人]` |
| 備份、還原演練與保存 | `[記錄輸入：RPO 1 小時／RTO 4 小時；須補頻率、責任人與演練證據]` | `[技術＋營運負責人]` |
