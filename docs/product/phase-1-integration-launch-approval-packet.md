...
2026-07-27 曾記錄英文版名稱 `Beau Essence Clinic` 與頁面需持續顯示人工電話。
**2026-08-16 業主答覆取代前者：不做英文版**；人工電話確認為 02-2577-1314，正式網址
則待與伺服器系統廠商討論後才能定案。這些仍待營運負責人在本表確認，不能以問卷紀錄
代替核准。
...
這三項核准不會單獨解除安全限制。D-006 已核准，且委派授權碼已有部分 server-side 驗證證據，但完整身分／Session／RBAC／稽核實作仍未完成；公開預約仍必須完成
