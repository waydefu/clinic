...
但一旦要輸入真實病患資料，就必須先完成 D-001～D-003，否則不得進行。
...
**目前系統的實作現況，供核准時對照：** 管理者可設定排班、回診、個管、帳號與
系統治理；櫃檯僅能建立預約、取消、改期、標記未到與到診。若診所要調整這個
分界，請在此註明。
