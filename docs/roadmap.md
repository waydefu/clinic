...
**2026-07-22 已修**：回饋可見性整批修正——所有建立／失敗訊息就地顯示（含
預約失敗原因）、sticky 狀態列、帳號重複防護、完成後改期閘門、患者端焦點
管理與 Enter 送出。見[回饋可見性檢查](reviews/ui-feedback-review-and-remediation-2026-07-22.md)。

仍未處理：

- 步驟指示器的文字標籤在桌面版未顯示（07-22 於 800px 寬實測有顯示，
  1280px 寬待複驗後才可移除此項）
