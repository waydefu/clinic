...
| Already Grok-solvable / landed | fail-closed `/v1/bookings` create/query/cancel/reschedule/complete/no-show; staff on-behalf; patient cutoff; D-006 session evaluator on CAL-PILOT `__session`; exact-head CI on the composing branch |
