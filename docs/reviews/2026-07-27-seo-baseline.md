...
> **文件生命週期註記（2026-07-28）：** 本頁保留 2026-07-27 當次檢查結果；同日
> 稍後已完成診所官網路由整合，因此 §4「官網不在本專案／尚未互連」是當時狀態，
> 不再代表現況。現行畫面與路由證據請看
> [2026-07-28 UI 視覺基準](ui-visual-baseline-2026-07-28.md)，整合交付證據請看
> [2026-07-27 診所官網整合交付](2026-07-27-clinic-site-integration-delivery.md)。
> 另：§2「門診時間與官網一致」只證明當時 repository 內四份合成來源彼此一致。
> 2026-07-28 重查診所官方預約頁後，官網仍發布週一至週五 11:00–20:00、週六
> 11:00–16:00，與合成預覽不同；正式時間現為 D-004 待決策，不得引用本頁判定。
