...
同一個尚未合併的首頁重構 PR 於當日追加測鼾聲 App 入口與品牌多層漸層，因此在基準
成為正式驗收證據前重拍兩張首頁圖；另外八張圖未改。這是同一實作批次的補充，不是
事後覆寫已發行的 production 基準。
...
孤立成一行。測鼾聲區塊在桌機為文案／下載面板雙欄、手機為單欄，三個連結完整可見；
深綠段落與其他淡色段落的漸層沒有降低文字辨識度。
