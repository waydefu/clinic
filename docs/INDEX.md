...
| deployment | D-010; Safety Floor 8; live split [first-stage C0 authority](architecture/first-stage-c0-authority.md) (`OWNER_AUTHORITY_CONFIRMED`; C0～C6 `completed` synthetic); C1～C6 [execution](architecture/first-stage-c1-c6-execution.md) | — | `stage-2-gate-status.json`; preview runbooks; dated [staging inventory](reviews/2026-09-09-staging-readonly-inventory.md) is not apply; WP-B1 A is API *direction*, not an exact-SHA Cloud Run packet; [2026-09-15 WP-B / F closure](reviews/2026-09-15-wp-b1-b11-signed-authority-and-f-closure.md); [Stage E](reviews/2026-09-15-stage-e-monitoring-readiness.md) is not deploy; [Stage F0 packet](reviews/2026-09-15-stage-f0-exact-sha-authority-packet.md) is unsigned and not apply | `.claude/hooks/guard-commands.mjs`; [C1 packet](runbooks/c1-local-execution-packet.md); [C2～C6 packet](runbooks/c2-c6-local-execution-packet.md); `scripts/sequential-c-gate.mjs`; [runbooks/synthetic-online-preview.md](runbooks/synthetic-online-preview.md); [Stage E ops](runbooks/stage-e-operational.md); [Stage F matrix](architecture/stage-f-deployed-acceptance-matrix.md) |
