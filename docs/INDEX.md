...
| API/domain | [architecture/domain-boundaries.md](architecture/domain-boundaries.md); `packages/domain`; `packages/contracts`; `packages/domain/src/roles.ts` | ADR-0001, ADR-0004, ADR-0005 | decision register for any policy-shaped change; [BOOK-PILOT proposal](product/2026-09-07-book-pilot-proposal.md) is plan-only and is not a route | `.claude/rules/domain-and-api.md` |
...
| deployment | D-010; Safety Floor 8; live split [first-stage C0 authority](architecture/first-stage-c0-authority.md) (`OWNER_AUTHORITY_CONFIRMED`; C0～C6 `completed` synthetic); C1～C6 [execution](architecture/first-stage-c1-c6-execution.md) | — | `stage-2-gate-status.json`; preview runbooks; dated [staging inventory](reviews/2026-09-09-staging-readonly-inventory.md) is not apply | `.claude/hooks/guard-commands.mjs`; [C1 packet](runbooks/c1-local-execution-packet.md); [C2～C6 packet](runbooks/c2-c6-local-execution-packet.md); `scripts/sequential-c-gate.mjs`; [runbooks/synthetic-online-preview.md](runbooks/synthetic-online-preview.md) |
...
| documentation/evidence | [document-lifecycle.md](document-lifecycle.md); this catalogue [README.md](README.md) | — | [state/current.md](state/current.md) | `.claude/rules/docs-and-evidence.md`; skills `handoff-record`, `closeout`; [Luna local completion](product/luna-local-project-completion-master-plan.md) |
