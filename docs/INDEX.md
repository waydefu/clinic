...
| documentation/evidence | [document-lifecycle.md](document-lifecycle.md); this catalogue [README.md](README.md) | — | [state/current.md](state/current.md) | `.claude/rules/docs-and-evidence.md`; skills `handoff-record`, `closeout`; [Grok→Luna last-mile](product/luna-local-project-completion-master-plan.md) |
