...
| deployment | D-010 in the register; AGENTS Safety Floor item 8 and Remain disabled; [architecture/infrastructure-and-operations-plan-2026-07-24.md](architecture/infrastructure-and-operations-plan-2026-07-24.md) (plan-only); live split [first-stage C0 authority](architecture/first-stage-c0-authority.md) (`OWNER_DIRECTION_APPROVED` / `ENGINEERING_RECOMMENDATION_COMPLETE` / `HUMAN_REVIEW_SIGNATURE_PENDING`); C1～C6 packets [first-stage C1～C6 execution](architecture/first-stage-c1-c6-execution.md) (`READY_FOR_EXPLICIT_AUTHORITY`) | — | `stage-2-gate-status.json` `deploymentAuthorities`; preview runbooks; dated [staging read-only inventory](reviews/2026-09-09-staging-readonly-inventory.md) is not apply authority | `.claude/hooks/guard-commands.mjs`; [runbooks/synthetic-online-preview.md](runbooks/synthetic-online-preview.md) |
