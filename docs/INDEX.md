...
| deployment | D-010; Safety Floor 8; live split [first-stage C0 authority](architecture/first-stage-c0-authority.md) (`OWNER_AUTHORITY_CONFIRMED`; C0 `completed`; C1 `granted`); C1～C6 [execution](architecture/first-stage-c1-c6-execution.md) | — | `stage-2-gate-status.json`; preview runbooks; dated [staging inventory](reviews/2026-09-09-staging-readonly-inventory.md) is not apply | `.claude/hooks/guard-commands.mjs`; [runbooks/synthetic-online-preview.md](runbooks/synthetic-online-preview.md) |
