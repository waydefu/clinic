...
共 10 張 reference-only PNG，覆蓋 warm-theme 工作臺週曆、Case follow-up、
booking Step 1～3 與 privacy-return flow。它們是人工跨電腦複核的參考
...
最後才把 required paths 指過去。2026-08-20 依此流程新增日期目錄，
沒有就地改寫 2026-08-10 或更早的 historical evidence；細節見該份基準文件。
