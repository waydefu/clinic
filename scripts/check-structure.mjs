...
const requiredPaths = [
  ...
  'apps/api/src/test-only-booking.controller.ts',
  'apps/api/src/test-only-booking.service.ts',
  'apps/web/public/admin-shell.html',
  'apps/web/public/admin-bootstrap.js',
  'apps/web/public/admin-v2.css',
  'apps/web/public/patient-app-v2.js',
