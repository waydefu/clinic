...
const requiredPaths = [
  ...
  'docs/reviews/2026-09-11-c0-engineering-acceptance.md',
  ...
  'docs/architecture/stage-f-source-readiness.md',
  'docs/templates/stage-f-exact-sha-authority-packet.md',
  ...
  'firebase.json',
  'firebase.isolated-preview.json',
  'firebase.isolated-api-preview.json',
  'scripts/internal-test-booking-smoke.mjs',
  ...
  'scripts/internal-test-c1-identity.mjs',
  'scripts/internal-test-image-names.mjs',
  'scripts/c1-config-contract.mjs',
  'scripts/firestore-index-plan.mjs',
  'scripts/stage-f-deployment-graph.mjs',
  'scripts/stage-f-source-closeout.test.mjs',
  'scripts/stage-f-synthetic-schedule-bootstrap.mjs',
  'scripts/stage-f-human-alert-proof.mjs',
  'scripts/stage-f-source-remediation.test.mjs',
  'scripts/c1-internal-test-run.test.mjs',
  'scripts/c1-firebase-auth-domain.mjs',
  'scripts/c1-firebase-auth-domain.test.mjs',
  ...
  'scripts/internal-test-migration-inspect.mjs',
  'scripts/internal-test-migration-inspect.test.mjs',
  'scripts/internal-test-hosting-inspect.mjs',
  'scripts/internal-test-hosting-inspect.test.mjs',
  'scripts/internal-preproduction-complete.mjs',
  'scripts/internal-preproduction-complete.test.mjs',
  'firestore.rules',
  ...
  'scripts/nest-module-reachability.mjs',
  'scripts/nest-module-reachability.test.mjs',
  'scripts/booking-route-truth.mjs',
  'scripts/booking-route-truth.test.mjs',
  'scripts/unrouted-inventory.test.mjs',
  'scripts/c0-authority-reconciliation.test.mjs',
  'scripts/c1-foundation.test.mjs',
  'scripts/c2-c6-source-invariants.test.mjs',
  'infra/terraform/c1-foundation/main.tf',
  'infra/terraform/c1-foundation/variables.tf',
  'infra/terraform/c1-foundation/versions.tf',
  'infra/terraform/c1-foundation/outputs.tf',
  'infra/terraform/c1-foundation/README.md',
  'infra/terraform/c2-identity/main.tf',
  'infra/terraform/c2-identity/variables.tf',
  'infra/terraform/c2-identity/versions.tf',
  'infra/terraform/c2-identity/README.md',
  'infra/terraform/c5-firestore/main.tf',
  'infra/terraform/c5-firestore/variables.tf',
  'infra/terraform/c5-firestore/versions.tf',
  'infra/terraform/c5-firestore/README.md',
  'infra/terraform/c6-calendar/main.tf',
  'infra/terraform/c6-calendar/variables.tf',
  'infra/terraform/c6-calendar/versions.tf',
  'infra/terraform/c6-calendar/README.md',
  'infra/terraform/wp-b4-alerting/main.tf',
  'infra/terraform/wp-b4-alerting/variables.tf',
  'infra/terraform/wp-b4-alerting/versions.tf',
  'infra/terraform/wp-b4-alerting/README.md',
  'infra/terraform/wp-b4-alerting/noop.tftest.hcl',
  'infra/terraform/c1-internal-test-run/main.tf',
  'infra/terraform/c1-internal-test-run/variables.tf',
  'infra/terraform/c1-internal-test-run/versions.tf',
  'infra/terraform/c1-internal-test-run/outputs.tf',
  'infra/terraform/c1-internal-test-run/README.md',
  ...
  'apps/api/src/platform/runtime/c1-firebase-auth-domain.test.ts',
  'infra/config/c1-internal-test-config-contract.json',
  'infra/firestore/query-index-matrix.json',
  'containers/internal-test.cloudbuild.yaml',
  'containers/internal-test-outbox.Dockerfile',
  'apps/api/src/platform/runtime/c1-required-config.ts',
  'apps/api/src/platform/runtime/c1-required-config.test.ts',
  ...
  'scripts/collect-c1-smoke.mjs',
  'scripts/collect-c1-smoke.test.mjs',
  'scripts/c2-c6-smoke-evidence.mjs',
  ...
  'infra/terraform/c1-foundation/noop.tftest.hcl',
  'infra/terraform/c2-identity/noop.tftest.hcl',
  'infra/terraform/c5-firestore/noop.tftest.hcl',
