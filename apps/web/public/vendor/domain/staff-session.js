...
export function evaluateStaffSession(input) {
    ...
    if (typeof input.accountDisabled !== 'boolean') {
        throw new DomainError('INVALID_VALUE', 'staffSession.accountDisabled must be a boolean');
    }
    ...
    if (nowMs < issuedMs)
        return { active: false, reason: 'not_yet_valid' };
