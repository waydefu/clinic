// 工作臺的分頁切換。
//
// 為什麼是 hash 路由而不是 tabs widget：這六個區塊是**各自獨立的工作區**
// （預約、排班、帳號…），不是同一份資料的替代視圖，因此語意上是導覽
// 而非 tablist。保留 <a href="#id"> 的好處很實際：
//   - 深連結：把工作區網址貼給同事，開起來就在那一頁
//   - 上一頁／下一頁與重新整理都維持在同一區
...
import { resolveScopedWorkbenchPanel } from './workbench-scope-policy.js';
